...
\hypertarget{full-model-notes-26-feb-2018}{%
...
Domain with boundary: \small\begin{align}
...
dielectric constant, and viscosity: \small\begin{align}
...
forms), \(Z\), and numerical parameters gives \small\begin{align}
...
\hypertarget{boundary-conditions-initial-conditions-and-steady-state-solutions}{%
...
\ldots{}towards the core (\(x=L\)): \small\begin{align}
...
Steady-State Solutions \small\begin{align}
...
\hypertarget{gradient-model-from-staps}{%
...
\begin{itemize}
\item
  Electron Anomalous Diffusion: \small\begin{align}
  ...
  \end{align}\normalsize
\item
  Charge Exchange Friction: \small\begin{align}
...
\tightlist
\item
  Ion Orbit Loss: \small\begin{align}
