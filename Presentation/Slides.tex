...
%\begin{itemize}
%	\item Which electric field-generating mechanisms are dominant in concrete experimental tokamak conditions?
%	\item Is the 
%\end{itemize}
%\end{frame}
...
\end{itemize}
\begin{align} % Ambipolarity constraint and Z definition
...
\section{Results}
\begin{frame} % Taylor-expanded state plot
...
\begin{minipage}{0.65\linewidth}
	\centering
	\includegraphics[width=0.9\textwidth]{../Graphics/Model_Graphs/Original_FS_0135.png}
\end{minipage}
...
\end{sagesilent}
\begin{frame} % Taylor-expanded show zeros
\frametitle{Taylor-Expanded Model}
\begin{figure}[h]
...
\TwoFigOneCap{\includegraphics[width=\linewidth]{../Graphics/Model_Graphs/state_G1e20_full_t200.png}}
	{\includegraphics[width=\linewidth]{../Graphics/Model_Graphs/flux_G1e20_full_t200_edited.png}}
...
\TwoFigOneCap{\includegraphics[width=\textwidth]{../Graphics/Model_Graphs/state_G1e21_full_t190.png}}
	{\includegraphics[width=\textwidth]{../Graphics/Model_Graphs/flux_G1e21_full_t190_edited.png}}
...
\begin{frame} % No steady-state, edge
\frametitle{Flux Model}

\begin{figure}[tb] % Fluxes vs Z for 40000, edge
	\centering
	\includegraphics[width=0.9\textwidth]{../Graphics/Model_Graphs/Fluxes_vs_Z_edge_t40000.png}
...
\begin{frame} % No steady-state, core
\frametitle{Flux Model}

\begin{figure}[tb] % Fluxes vs Z for 40000, core
	\centering
	\includegraphics[width=0.9\textwidth]{../Graphics/Model_Graphs/Fluxes_vs_Z_core_t40000.png}
