...
One of the liberties taken to simplify the model is that a single temperature is used, \emph{i.e.} the electron and ion temperatures are assumed identical.\todo{\color{red}{Liberties?}}
...
As shown previously, the radial electric field $E_r$ is normalized with the ion poloidal gyroradius $\rho_p$ into $Z$ for this investigation, shown in Equation~\ref{eq:Z_and_rho_definitions}.
