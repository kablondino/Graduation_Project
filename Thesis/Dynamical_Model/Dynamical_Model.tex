...
For added context, the profiles of these fluxes will also be given with abstract L-- and H--mode density, temperature, and $Z$ profiles, given in Figures~.\todo{\color{red}FIGURES!}
...
\begin{align} % Polarization current
	J^\text{pol} \,=\, \frac{m_i \, n}{\epsilon_0\,\mu_0 \, B_\theta^2} \, \frac{\partial E_r}{\partial t}
...
It is written with the normalized electric field as
...
\end{align}
The steps between the two form are shown in Appendix \ref{chapter:Normalization}.
...
\end{align}
Previous investigations using this form have had a variety of choices for the parameters, including $c = 0.25, \gamma = 2$, and $c = 1, \gamma = 2/3$ \cite{connor_review_2000} \cite{itoh_theoretical_1994}.
...
\todo{\color{red}Initial conditions?}
