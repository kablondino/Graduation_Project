...
\begin{tabular}{ccccccccc}
	$\epsilon$ & $\mu$ & $c_n$ & $c_T$ & $a$ & $b$ & $c$ & $Z_S$ & $\zeta$ \\ \hline
	$\frac{1}{25}$ & $\frac{1}{20}$ & -1.1 & -0.9 & 1.5 & 2.0 & -1.0 & -1.5 & 0.5
\end{tabular}
\end{table}
...
The typical decay length scales are chosen as the following:
\begin{table}[h]
\centering
\begin{tabular}{r|ccc}
...
The following chapter describes the choice made for this investigation using FiPy, a solver written in Python  that uses the Finite Volume Method.
